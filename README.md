...
Proyecto finalizado y subido al repositorio Git para su entrega y revisión.

El código fuente, la estructura del proyecto y las pruebas automatizadas se encuentran disponibles en este repositorio.

🎓 Proyecto académico

Actividad académica sobre diseño e implementación de una arquitectura en capas para un sistema de facturación comercial.
